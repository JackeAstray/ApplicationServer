...
namespace ApplicationServer.Manager
{
    ...
    /// POST 请求
    /// </summary>
    public partial class HttpApplicationSession
    {
        /// <summary>
        /// 验证Token
        /// </summary>
        ...
        public void HandleLoginRequest(HttpRequest request)
        {
            try
            {
                ...
                else
                {
                    ...
                    SetErrorResponse("用户不存在，或账户密码错误。");
                }
            }
            catch (Exception ex)
            {
            ...
            try
            {
                ...
                if (user == null)
                {
                    ...
                    else
                    {
                        ...
                        SetErrorResponse("注册失败，数据无法写入，请联系管理员。");
                    }
                }
                else
                {
                    Log.Error("用户已存在");
                    SetErrorResponse("用户已存在");
                }
            }
            catch (Exception ex)
            {
